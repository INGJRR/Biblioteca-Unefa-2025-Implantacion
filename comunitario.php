...
<body>
	...
	<section id="content">
		...
		<br><br>
		<h4 style="font-size: 25PX; text-align: center; margin: 20px; font-weight: bolder; letter-spacing: 3px;">LISTADO DE TODOS LOS TRABAJOS DE SERVICIO COMUNITARIO</h4>
		<main>
            ...
            <div id="main-container">
                ...
                <table class="busquedatabla">
                    ...
                    <tr>
                        ...
                        <td><?= $sv["lugar"]?></td>
						<td>
							<a href="./modificar/sc.php?cota=<?= $sv["cota"] ?>" class="button">
