...
<body>
	...
	<section id="content">
		...
		<br><br>
		<h4 style="font-size: 25PX; text-align: center; margin: 20px; font-weight: bolder; letter-spacing: 3px;">LISTADO DEl PERSONAL ADMINISTRATIVO</h4>
		<main>
					...
					<table class="busquedatabla">
						...
						<?php foreach ($obreros as $obrero): ?>
							<tr>
								...
								<td>
									<a href="./modificar/personalUnefa.php?cedula=<?= $obrero["cedula"] ?>&tipo=2" class="button">
