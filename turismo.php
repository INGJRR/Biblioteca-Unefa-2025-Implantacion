...
<head>
	...
	<!--  CSS -->
	<link rel="stylesheet" href="./estilo/turismo.css">
	...
	<section id="content">
		<nav>
			...
			<?php if(isset($estudiantes)){
				$url_buscar = './turismo.php';
				require './componentes/buscador.php';
				} 
			?>
		</nav>
		<br><br>
		<h4 style="font-size: 25PX; text-align: center; margin: 20px; font-weight: bolder; letter-spacing: 3px;">LISTADO DE LOS ESTUDIANTES DE LIC EN TURISMO</h4>
		<main>
