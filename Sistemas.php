	...
	<section id="content">
		<nav>
			...
			<?php if(isset($estudiantes)){
				$url_buscar = './Sistemas.php';
				require './componentes/buscador.php';
			} ?>
		</nav>
		<br><br>
		<h4 style="font-size: 25PX; text-align: center; margin: 20px; font-weight: bolder; letter-spacing: 3px;">LISTADO DE ESTUDIANTES DE INGENIERÍA EN SISTEMAS</h4>
		<main>
