...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_trabajo_inv = "INSERT INTO trabajos_investigacion (titulo, autor, nivel_academico, fecha_presentacion, carrera, fecha_registro, cantidad, linea_investigacion, mencion, metodologia, metodo, tipo, palabras_claves, cota) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
