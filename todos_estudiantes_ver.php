...
<head>
	...
	<!--  CSS -->
	<link rel="stylesheet" href="./estilo/sistemas.css">
	...
	<section id="content">
		<nav>
			...
			<?php if(isset($estudiantes)){
				$url_buscar = './todos_estudiantes_ver.php';
				require './componentes/buscador.php';
			} ?>
		</nav>
		<br><br>
		<h4 style="font-size: 25PX; text-align: center; margin: 20px; font-weight: bolder; letter-spacing: 3px;">LISTADO DE TODOS LOS ESTUDIANTES</h4>
		<main>
						...
						<tr>
							...
							<?php 
								...
								if($ActivoNum > 0){
									...
									require ROOT_DIR . '/modelo/conexion.php';
									Moroso($cedula_actual, 1, $conexion);
								}else{
									require_once ROOT_DIR . '/funciones/convertirMoroso.php';
									quitarMoroso($cedula_actual, 1, $conexion);
								}
								echo $ActivoNum;
							?>
							</td>
