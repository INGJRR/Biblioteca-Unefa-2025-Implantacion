...
require_once ROOT_DIR . '/controlador/registrar/pasantia.php';
?>
...
<body>
	...
	<section id="content">
		...
		<h4 style="font-size: 25PX; text-align: center; margin: 20px; font-weight: bolder; letter-spacing: 3px;" >REGISTRAR TRABAJO DE PASANTIA</h4>
		<main>
			<!-- FORMULARIO -->
