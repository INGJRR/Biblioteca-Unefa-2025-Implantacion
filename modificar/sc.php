...
<body>
	...
	<section id="content">
		...
		<br><br>
		<h4 style="font-size: 25PX; text-align: center; margin: 20px; font-weight: bolder; letter-spacing: 3px;" >MODIFICAR TRABAJO DE SERVICIO COMUNITARIO</h4>
		<main>
			<!-- FORMULARIO -->
			<form class="formulario" id="formulario" method="POST">
				...
				<div class="formulario_grupo">
					...
					<label for="usuario" class="formulario__label">Ejemplares *</label>
					<div class="formulario__grupo-input">
